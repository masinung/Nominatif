        ...
        <div class="form-group" style="height: 680px;">
            <div class="row register-form" style="height: 680px;">
                <div class="col-md-8 offset-md-2" style="height: 680px;">
                    <form method="POST" class="custom-form" action="aksi/simpan" >
                        <h1>Tambah Data</h1>
                        <div class="form-row form-group">
                            <div class="col-sm-4 label-column"><label class="col-form-label" for="name-input-field">NRP&nbsp;</label></div>
                            <div class="col-sm-6 input-column"><input class="form-control" type="number" name="nrp" required=""></div>
                        </div>
                        <div class="form-row form-group">
                            <div class="col-sm-4 label-column"><label class="col-form-label" for="name-input-field">Nama&nbsp;</label></div>
                            <div class="col-sm-6 input-column"><input class="form-control" type="text" name="nama" required=""></div>
                        </div>
                        <div class="form-row form-group">
                            <div class="col-sm-4 label-column"><label class="col-form-label" for="email-input-field">Pangkat</label></div>
                            <div class="col-sm-6 input-column"><input class="form-control" type="text" name="pangkat" required=""></div>
                        </div>
                        <div class="form-row form-group">
                            <div class="col-sm-4 label-column"><label class="col-form-label" for="pawssword-input-field">Jabatan</label></div>
                            <div class="col-sm-6 input-column"><textarea class="form-control" name="jabatan"></textarea></div>
                        </div>
                        <div class="form-row form-group">
                            <div class="col-sm-4 label-column"><label class="col-form-label" for="dropdown-input-field">Kesatuan</label></div>
                            <div class="col-sm-4 text-left input-column"><select class="border rounded custom-select multiselect-ui form-control" name="kesatuan" style="width: 110px;">
                            <option value="" disabled selected>Pilih Kesatuan</option>
                            <option value="Polres Pasuruan">Polres Pasuruan</option>
                            <option value="Mutasi">Mutasi</option></select></div>
                        </div>
                        <div class="form-row form-group">
                            <div class="col-sm-4 label-column"><label class="col-form-label" for="repeat-pawssword-input-field">TMT Awal</label></div>
                            <div class="col-sm-6 input-column"><input class="form-control" type="date" name="tmt_awal"></div>
                        </div>
                        <div class="form-row form-group">
                            <div class="col-sm-4 label-column"><label class="col-form-label" for="repeat-pawssword-input-field">TMT Akhir</label></div>
                            <div class="col-sm-6 input-column"><input class="form-control" type="date" name="tmt_akhir"></div>
                        </div>
                        <button class="btn btn-light submit-button" type="submit" name="submit" style="background-color: rgb(26,180,69);">Simpan</button>
                        <button class="btn btn-light submit-button" type="button" style="background-color: rgb(228,83,83);" onclick="goBack()">Batal</button>
                    </form>
                </div>
            </div>
        </div>
