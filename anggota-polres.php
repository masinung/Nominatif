...
<head>
    ...
    <title>Data Nominatif Anggota Polres Pasuruan </title>
...
<body id="page-top"> 
        ...
        <div class="container"><a class="navbar-brand" href="anggota-polres">Data Nominatif</a><button data-toggle="collapse" class="navbar-toggler" data-target="#navcol-1"><span class="sr-only">Toggle navigation</span><span class="navbar-toggler-icon"></span></button>
            <div class="collapse navbar-collapse"
                ...
                <ul class="nav navbar-nav mr-auto">
                    <li class="nav-item dropdown"><a class="dropdown-toggle nav-link" data-toggle="dropdown" aria-expanded="false" href="#">Data Anggota</a>
                        <div class="dropdown-menu" role="menu">
                            <a class="dropdown-item disabled" role="presentation" href="#">Data Anggota</a>
                            <a class="dropdown-item" role="presentation" href="anggota-mutasi">Data Anggota Mutasi</a>
                            <!-- <a class="dropdown-item" role="presentation" href="mhs-alumni">Mahasiswa Alumni</a> -->
                        </div>
                    </li>
                    <li class="nav-item" role="presentation"><a class="nav-link" href="cetak-anggota-polres" target="_blank">Cetak</a></li>
    ...
    <div class="container text-dark" style="height: 470px;padding: 10px;">
        <h1 class="text-center">Data Nominatif Anggota Polres Pasuruan</h1>
            ...
            <table class="table table-striped table-bordered table-hover">
                ...
                <tbody class="text-left">
                            ...
                            if(isset($_GET['cari'])){
                                ...
                                $sql = "SELECT * FROM data_nominatif where kesatuan ='Polres Pasuruan' and nrp like '%".$cari."%'";
                                $result = mysqli_query($koneksi, $sql);
                                $total = mysqli_num_rows($result);
                                $pages = ceil($total/$halaman); 
                                $sql2 = "SELECT * from data_nominatif where kesatuan ='Polres Pasuruan' and nrp like '%".$cari."%' LIMIT $mulai, $halaman" ;          
                                ...
                                $page = isset($_GET["halaman"]) ? (int)$_GET["halaman"] : 1;
                                $mulai = ($page>1) ? ($page * $halaman) - $halaman : 0;
                                $sql = "SELECT * FROM data_nominatif where kesatuan ='Polres Pasuruan'";
                                $result = mysqli_query($koneksi, $sql);
                                $total = mysqli_num_rows($result);
                                $pages = ceil($total/$halaman); 
                                $sql2 = "SELECT * from data_nominatif where kesatuan ='Polres Pasuruan' LIMIT $mulai, $halaman" ;          
                                $query = mysqli_query($koneksi, $sql2) or die("Galat !");
