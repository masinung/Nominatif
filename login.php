...
<body id="page-top">
    <div class="login-clean" style="height: 770px;">
        <form action="aksi/cek-login" method="post">
            <h1 class="text-center">Masuk</h1>
            <div class="illustration"><img src="assets/img/tribrata.png" height ="200px" width ="200"></div>
            <div class="form-group"><input class="border rounded border-warning form-control" type="text" data-bs-hover-animate="pulse" name="username" id="username" placeholder="Username" required=""></div>
            <div class="form-group"><input class="border rounded border-warning form-control" type="password" data-bs-hover-animate="pulse" name="password" id="password" placeholder="Password" required=""></div>
            <div class="form-group"><button class="btn btn-warning btn-block" data-bs-hover-animate="pulse" type="submit">Log In</button></div><a class="forgot" href="#">Lupa User/Password ? Hubungi ADMIN</a></form>
    </div>
